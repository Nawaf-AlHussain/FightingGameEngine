...
#endif
                        logg("[WRAPPER] startDrawing...");
                        startDrawing();
                        logg("[WRAPPER] drawHandledAnimations...");
                        drawHandledAnimations();
                        logg("[WRAPPER] drawHandledCollisions...");
                        drawHandledCollisions();
                        logg("[WRAPPER] drawActorHandler...");
                        drawActorHandler();
                        logg("[WRAPPER] screen draw...");
                        if (gPrismWrapperData.mScreen->mDraw) {
                                gPrismWrapperData.mScreen->mDraw();
                        }
                        logg("[WRAPPER] stopDrawing...");
                        stopDrawing();
                }
        }
