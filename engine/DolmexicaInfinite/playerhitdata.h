...
// Returns 1 if any HitOverride slot is currently active (i.e. the player would
// enter the override state rather than the gethit state on the next hit).
// Mirrors Ikemen GO's `c.hoverIdx >= 0` semantics.
