...
static void addHistoryBufferElement(DreamPlayer* tPlayer) {
        ...
        setMugenAnimationDrawScale(e.mAnimationElement, Vector2D(getPlayerScaleX(tPlayer), getPlayerScaleY(tPlayer)) * tPlayer->mTempScale * getPlayerToCameraScale(tPlayer) * getGlobalCharacterDrawScale());
