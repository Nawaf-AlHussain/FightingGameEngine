...
enum DreamMugenStateControllerType : uint8_t{
        ...
        MUGEN_STATE_CONTROLLER_TYPE_SET_ROOT_VARIABLE,
        MUGEN_STATE_CONTROLLER_TYPE_ROOT_ADD_VARIABLE,
        ...
        MUGEN_STATE_CONTROLLER_TYPE_MAP_SET,
        MUGEN_STATE_CONTROLLER_TYPE_MAP_ADD,
        MUGEN_STATE_CONTROLLER_TYPE_MODIFY_HIT_DEF,
        MUGEN_STATE_CONTROLLER_TYPE_MODIFY_REVERSAL_DEF,
        MUGEN_STATE_CONTROLLER_TYPE_MODIFY_PROJECTILE,
